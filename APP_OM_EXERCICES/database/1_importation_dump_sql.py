"""Importation du fichier DUMP de la base de donnée
Fichier : 1_importation_dump_sql.py
Auteur : OM 2021.03.03 Connection à la base de donnée et importation du fichier DUMP
...
"""
from APP_OM_EXERCICES.database import database_tools

try:
    database_tools.ToolsBd().load_dump_sql_bd_init()
except Exception as erreur_load_dump_sql:
    print(f"202228032327 Initialisation de la BD Impossible ! (voir DUMP ou .env) "
