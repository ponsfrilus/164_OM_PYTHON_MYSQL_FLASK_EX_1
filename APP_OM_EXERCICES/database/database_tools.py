...
from APP_OM_EXERCICES import HOST_MYSQL
from APP_OM_EXERCICES import NAME_BD_MYSQL
from APP_OM_EXERCICES import NAME_FILE_DUMP_SQL_BD
from APP_OM_EXERCICES import PASS_MYSQL
from APP_OM_EXERCICES import PORT_MYSQL
from APP_OM_EXERCICES import USER_MYSQL
from APP_OM_EXERCICES.errors.exceptions import *
    ...
    def test_cmd_CRD_file_dump_sql():
        ...
        try:
            if os.path.exists(NAME_FILE_DUMP_SQL_BD):
                ...
                """
                    Pour CE projet et uniquement dans des projets (d'école) où l'on doit reconstruire la BD.
...
class DBconnection:
    ...
    def __init__(self):
        try:
            ...
            raise print(f"11145522154 Probème de connection dans {self.__class__.__name__} constructor")
